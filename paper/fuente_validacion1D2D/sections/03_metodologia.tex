...
\item Arquitectura SIREN $5\times128$, $\omega_0 = 1.0$, SEED = 42.
      ...
      entrenamiento, ya que los dos residuos (real e imaginario) duplican
      la contribución de la física y generan gradientes de gran magnitud
      en \texttt{float32}. No es un caso de no convergencia por agotar
      épocas, sino una falla numérica.
\end{tablenotes}
\end{threeparttable}
\end{table}
