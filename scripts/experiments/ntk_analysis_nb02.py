...
model = load_model(model, 'nb02_helmholtz2d_gpu', notebook_dir=str(PROJECT_ROOT / "notebooks"), device=device)
model.eval()
...
out_path = PROJECT_ROOT / "results" / "ntk_spectral_bias_diagnostics" / "ntk_nb02.json"
