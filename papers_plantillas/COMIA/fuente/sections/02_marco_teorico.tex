...
Las PINNs, introducidas por Raissi et al.~\cite{Raissi2019_PINNs} y revisadas extensamente en
Karniadakis et al.~\cite{Karniadakis2021_review} y Cuomo et al.~\cite{Cuomo2022_review}, aproximan la solución de una
...
Sitzmann et al.~\cite{Sitzmann2020_SIREN} proponen las redes SIREN (\textit{Sinusoidal Representation
