...
\begin{enumerate}
  \item \textbf{Precisión excepcional en 1D y 2D.}
    ...
    superando en factores de $\times 415$ y $\times 11.2$ al estado del arte de
    Schoder y Kraxberger~\cite{Schoder2024_PINN_acoustics}.
    Ambos valores cumplen holgadamente el umbral de tesis ($< 5\%$).
