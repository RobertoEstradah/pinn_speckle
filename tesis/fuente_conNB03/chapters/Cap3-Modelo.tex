...
%
\begin{equation}
    E(x, 0) = e^{i\phi(x)}, \quad
    \phi(x) \sim \mathcal{U}(0, 2\pi),
    \label{eq:frontera_rugosa}
\end{equation}
%
donde $\phi(x)$ se muestrea en $N_\phi = 256$ puntos equiespaciados. Esta
condición modela una pantalla de fase aleatoria cuya desviación estándar cumple
$\sigma_\phi > 2\pi$, condición suficiente para \textit{speckle} completamente
desarrollado \parencite{goodman2007speckle, fang2020physics}.
...
evalúa la solución exacta (o la condición de fase aleatoria en NB03) y se
