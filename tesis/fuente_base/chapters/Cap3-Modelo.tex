...
El umbral de la tesis es $\varepsilon_{L^2} < 5\%$. No existe en la literatura
de PINNs un criterio estandarizado para definir un umbral de error aceptable
en la resolución de la ecuación de Helmholtz, por lo que se fijó
...
reportado en trabajos comparables de la literatura
(Tabla~\ref{tab:comparativa}).
