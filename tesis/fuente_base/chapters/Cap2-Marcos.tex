...
Cuando una superficie rugosa con variación de fase $\Delta\phi \gg 2\pi$ es
...
El entrenamiento sigue una estrategia bifásica \parencite{cuomo2022scientific}:
...
El trabajo más directamente relacionado es el de \textcite{schoder2024helmholtz},
que realizó un estudio de factibilidad resolviendo la ecuación de Helmholtz en
3D con PINNs de activación \textit{tanh}, reportando un error $L^2 = 2.49\%$
(1D) y $L^2 = 1.91\%$ (2D) respecto a soluciones FEM de referencia. Este
trabajo establece la línea base de comparación para la presente investigación.
...
\begin{itemize}
    ...
    mediante CUDA \parencite{raissi2019physics}.
