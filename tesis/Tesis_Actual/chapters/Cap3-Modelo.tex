...
\end{equation}
%
La base se trunca a los $41$ modos propagantes ($k_{x,m}^2<k^2$). Los modos
...
La extensión a distancias mayores que $1\lambda$ sí emplea una división del
dominio longitudinal en bloques, en la que cada bloque recibe el campo y la
derivada de la interfaz anterior por la misma construcción de la
ecuación~\eqref{eq:cauchy_dura_cap3}; esa extensión se reporta por separado y
con su propio alcance de validación.
