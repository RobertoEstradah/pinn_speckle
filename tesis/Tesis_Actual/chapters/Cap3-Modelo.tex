...
En NB01 y NB02, los $N_b = 300$ puntos de frontera por borde se distribuyen
uniformemente sobre cada uno de los cuatro lados del dominio $\partial\Omega$.
Para cada lado, se evalúa la solución exacta y se construye el par
$(\mathbf{r}^b_j,\, E(\mathbf{r}^b_j))$ utilizado en $\mathcal{L}_\text{datos}$.
NB03 sigue un esquema distinto, descrito en la Sección~\ref{cap3:nb03}: solo
...
Peso de física $\lambda_\text{fís}$ & 0.1  & NB02, NB03 \\
\bottomrule
\end{tabular}
