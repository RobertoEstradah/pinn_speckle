...
converge. Desde una perspectiva más empírica, \textcite{krishnapriyan2021characterizing}
caracterizan sistemáticamente los modos de falla de las PINN con pesos fijos
entre los términos de datos y de física, mostrando que el entrenamiento puede
estancarse en soluciones incorrectas incluso cuando la pérdida global parece
decrecer — un fenómeno que se retoma en el Capítulo~\ref{cap4:resultados} al
analizar la ablación del peso de física $\lambda_\text{fís}$.
