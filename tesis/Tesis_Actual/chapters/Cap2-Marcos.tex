...
\textcite{goodman2007speckle}. Esta investigación se propone cerrar dicha
brecha; los Capítulos~\ref{cap3:modelo} y \ref{cap4:resultados} documentan
el avance metodológico logrado en la validación 1D/2D del enfoque y el
estado en progreso de su aplicación al \textit{speckle} óptico.
