...
screen
($L^2=0.993\%$) and up to $z=5\lambda$ through domain decomposition into five
local networks coupled by hard Cauchy conditions ($L^2=2.244\%$ at the end of
the path and a maximum of $3.507\%$ across $201$ planes), in both cases over
five known phase realizations.
