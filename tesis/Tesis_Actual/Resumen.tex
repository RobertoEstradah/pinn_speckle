...
por pantalla
($L^2=0.993\%$) y hasta $z=5\lambda$ mediante descomposición del dominio en
cinco redes locales acopladas por condiciones de Cauchy duras
($L^2=2.244\%$ al final del recorrido y un máximo de $3.507\%$ sobre $201$
planos), en ambos casos sobre cinco realizaciones de fase conocidas.
