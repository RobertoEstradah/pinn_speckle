...
de 2025. El trabajo realizado desde entonces cambió el método, y hay cuatro
afirmaciones del capítulo que el código ya no respalda.

\noindent
\textbf{Ninguna se ha modificado.} Este documento presenta cada una con su texto
...
\vspace{0.3em}
\noindent
\textbf{¿Se acepta el subtítulo, o se deja sólo la parte corta?}
